    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="<?= base_url('Admin/Jurusan') ?>">
                    <?= csrf_field(); ?>
                    <div class="form-group">
                        <label>Kode Jurusan</label>
                        <input maxlength="4" autocomplete="off" class="form-control" required type="text" name="kode_jurusan_param" placeholder="Masukkan Kode Jurusan..." />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="buttonAddJurusan" class="btn btn-primary">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
