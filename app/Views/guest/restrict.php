            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <div class="error mx-auto" data-text="504">504</div>
                        <p class="lead text-gray-800 mb-5">Access not Granted</p>
                        <p class="text-gray-500 mb-0">Halaman hanya dapat diakses oleh Admin...</p>
                        <a href="<?= base_url('guest/home') ?>">&larr; Back to Dashboard</a>
                    </div>
